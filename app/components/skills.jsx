...
export default function Skills() {
  ...
  return (
    ...
    >
      <section ref={sectionRef} className="relative py-20 px-4 sm:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <div className="inline-flex items-center gap-2 bg-gradient-to-r from-gray-900 to-gray-800 px-6 py-2 rounded-full mb-6 backdrop-blur-lg border border-gray-800">
          ...
          <div
            ...
            style={{
              transitionDelay: `${(skillCategories.length + 2) * 200}ms`,
            }}
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center group">
                <div className="w-20 h-20 bg-gradient-to-br from-blue-500/10 to-purple-500/10 rounded-full flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-300">
                  <FaLightbulb className="text-3xl" />
                </div>
                <h4 className="text-xl font-bold text-gray-200 mb-3 group-hover:text-yellow-400 transition-colors">
                  Innovative Solutions
                </h4>
                <p className="text-gray-400 text-sm leading-relaxed">
                  I approach every project with creativity and innovation,
                  finding unique solutions to complex challenges.
                </p>
              </div>
              ...
              <div className="text-center group">
                ...
                <p className="text-gray-400 text-sm leading-relaxed">
                  I work closely with clients and teams to ensure every project
              ...
              <div className="text-center group">
                ...
                <p className="text-gray-400 text-sm leading-relaxed">
                  I deliver high-quality results efficiently, ensuring your
