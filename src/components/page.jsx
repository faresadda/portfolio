...
export default function Page({indexskill,indexservice}) {
  ...
  return (
    <page className="fixed top-[50%] left-[50%] transform translate-x-[-50%] translate-y-[-50%] px-4 py-20 bg-white rounded-2xl shadow-lg w-[50%] z-50
    max-[1110px]:w-[70%] max-[657px]:w-[90%]">
        <IoClose className="absolute top-4 right-5 text-3xl" onClick={()=>{setPageexist(null)}}/>
        {pageexist==='skills' && <div className="flex flex-col items-center justify-center">
